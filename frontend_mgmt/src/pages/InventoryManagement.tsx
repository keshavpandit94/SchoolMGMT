...
import { Plus, Edit2, Trash2, ChevronDown, ChevronUp, History, Package } from 'lucide-react';
                ...
                return (
                  <React.Fragment key={item._id}>
                    ...
                    >
                      ...
                      <TableCell>
                        <Avatar src={item.imageUrl} variant="rounded" sx={{ width: 38, height: 38, bgcolor: 'rgba(99, 102, 241, 0.1)' }}>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <DialogContent sx={{ mt: 2 }}>
            <Grid container spacing={2.5}>
              <Grid item xs={12}>
                <Typography variant="body2" sx={{ color: '#94A3B8', mb: 1 }}>Asset Image:</Typography>
                <ImageUploader
